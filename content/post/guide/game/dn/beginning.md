...
而我现在入坑《DN》的原因也有很多，其中之一是工作，另一个则是无法忍受中文互联网上如此低下的信息效率——除了官方平台之外，你很难再找到时效性足够的信息。

![image.png](https://tva1.sinaimg.cn/large/006R15FXgy1h8cz18m1zaj31pc1ese2r.jpg)

<!--more-->

这对于一款有MMO属性的作品来说近乎灾难，这意味着新玩家有厚重的信息壁垒，并不利于后期发展，所以才有了今天这篇文章。

## 账号服务器角色选择与心理准备篇

根据我在全网搜索的实际情况，龙之谷作为一款老牌韩游，它的肝度可以说是非常逆天的，几乎每个常玩这游戏的玩家都会有“连体号”，而且起底要把所有职业都练一次——总共10个，以凑满游戏里的种种属性加成条件。

![image.png](https://tva1.sinaimg.cn/large/006R15FXgy1h8cyw18j6dj302u06q753.jpg)

所谓“连体号”指的是的同一个账号在一个大区之下的一个服务器中建立有多个角色，且角色之间有主号与小号的区别。如果你玩过DNF，你一定能明白是什么意思。这招是传统MMO职业设计的产物，后来为了解决这种小号泛滥的问题，演变出了单职业可以体验全内容的设计，比如PSO2和FF14。
...
这几乎是所有无双系MMO的通病，无论《全境封锁2》还是《Warframe》（又叫《星际战甲》），没有任何一个游戏能避开。DN在这方面可能显得比较极端，但比起战甲的1个键按一下午的模式还是要好得多了。
...
无论哪个其实都是无底洞一样的大坑，PSO2充值10000日元也就30发抽奖打个水漂，战甲199刀也就一套P甲。**DN的坑挖得早所以深**，但好歹明码标价，如果不想真的追求非常极限的输出——就好比你一定要配一台全世界性能最牛逼的PC——其实大可慢慢玩下去。PSO2搬砖领周常工资可以配一套很不错的装备，DN其实也可以。

![PSO2氪金](https://tva1.sinaimg.cn/large/006R15FXgy1h8czczkqmuj30sg0g0nc3.jpg)

MMORPG在游戏过程中会给玩家制造需求，这可以说是公开的秘密。因此，只要你能摆正需求，那肯定能提出合理的解决方案。无论手游还是端游，**氪金本质上都是花钱节省时间**。

我有个朋友，他玩DMCV（《鬼泣5》）的时候为了节省时间，甚至直接微交易购买了游戏内的红魂石，一次性解锁了所有的技能，然后直接钻进血宮（爬塔模式）开始琢磨游戏的动作系统。

![鬼泣5当时的氪金要素甚嚣尘上](https://tva1.sinaimg.cn/large/006R15FXgy1h8czeybl3mj31de0rskjl.jpg)

玩家不会正视自己没钱的现实。**传统端游构建的往往是异于现实的社交体验**，而非代入角色获得的想象体验，因此单机玩家一定要做好自己的心理建设，而WOW模式的玩家也要理解其中的节奏感差异。在DN中，你关注的点可能全都不存在，但你如果能深入进去，一定会发现其中完全异于之前经历的乐趣。

而这就是DN能在今天也仍然有人热爱的常青之力。

你可以把它当做精灵的永恒之井，也可以把它当做艾欧泽亚的水晶神话。
...
DN的时装氪金无非是增加PVE属性，和套装装备一样有花里胡哨的属性加成。这种加成的规则限制更少，所以许多老玩家一定会有很多套时装备用。除此之外，还有各种强化礼包和装逼专用功能专门噶韭菜，如果抛开这些内容，游戏本身其实需要的氪金点不是特别多。

![键位设置](https://tva1.sinaimg.cn/large/006R15FXgy1h8czngg1twj30ee09yafg.jpg)

**如果你实在是不愿意大量氪金节省时间瞬间变美，那我们完全可以放长线钓大鱼，反正不用交点卡钱，你也可以成为零氪铁公鸡**。
...
DN的战斗系统是无锁定的，角色没有转身动作也没有转身时间，鼠标瞄准的方向就是角色面朝的方向，除了个别职业的技能之外，其他动作几乎都是瞬发。不过也正是因为如此设计，如果用手柄体验游戏，可能没有键鼠来的精准。

它当年有3D DNF的称号，是在于他确实保留了传统街机游戏的“招式表”，但做了极大幅度的简化，变成了“招式派生”，绝大多数技能只要一个键就能释放。在这种层面上，它更像是一个即时制的WOW，后来的《洛奇英雄传》也采用了类似的模式，让它转变成了一个连续刷本为主要内容的MMOARPG。
...
新手玩ACT喜欢不停地按同一个键攻击，但由于没有立回基础，所以很容易空招。且由于普通攻击几乎没啥卵用，新玩家上手之后也不可能打出任何一套完整的连招，再加上键盘天生不适合打ACT，在看过技能演示之后兴奋上手尝试，发现手脑协调如小儿麻痹，极容易产生心理落差以至被劝退。
...
但我现在也就满级了一个浪客，舞娘只有40级，待日后满级再慢慢更新。
